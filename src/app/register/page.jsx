...
import { Loader2, Mail, Lock, User, ArrowRight, Lightbulb } from "lucide-react";
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`input-field pl-10 ${passwordError ? "border-red-500 focus:ring-red-500" : ""}`}
                placeholder="••••••••"
              />
            </div>
            {passwordError && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`input-field pl-10 ${confirmPasswordError ? "border-red-500 focus:ring-red-500" : ""}`}
                placeholder="••••••••"
              />
            </div>
